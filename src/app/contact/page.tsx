    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .submit-btn {
          ...
          animation: con-shimmer 4s linear infinite;
        ...
        .area-chip {
          ...
          background: #f0f2ff; color: #3B4FCC;
      ...
      <main style={{ fontFamily: 'Poppins, sans-serif', background: 'linear-gradient(175deg, #f0f2ff 0%, #f8f9ff 50%, #eef0fb 100%)' }}>
        ...
        <section style={{ position: 'relative', overflow: 'hidden', minHeight: '520px', display: 'flex', alignItems: 'center', padding: '100px 0 90px' }}>
          ...
          <div style={{ position: 'absolute', inset: 0, backgroundImage: `url('YOUR_IMAGE_URL_HERE')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', zIndex: 0, backgroundColor: '#0d1340' }} />
        ...
        <section style={{ maxWidth: 1400, margin: '-40px auto 0', padding: '0 24px', position: 'relative', zIndex: 10 }}>
          <div className="con-fade con-d4 info-cards-row" style={{ display: 'flex', gap: 20, flexWrap: 'wrap' }}>
            ...
            <div className="info-card">
              ...
              <div style={{ position: 'absolute', right: -8, top: 4, opacity: 0.05, pointerEvents: 'none' }}>
                <MapPin size={72} color="#3B4FCC" strokeWidth={1} />
              </div>
              <div>
            ...
            <div className="info-card">
              ...
              <div style={{ position: 'absolute', right: -8, top: 4, opacity: 0.05, pointerEvents: 'none' }}>
                <Phone size={72} color="#10B981" strokeWidth={1} />
              </div>
              <div>
                ...
                <p style={{ fontSize: '0.9rem', color: '#6B7280', lineHeight: 1.6 }}>
                  sandyssparkletouch@gmail.com<br />
            ...
            <div className="info-card">
              ...
              <div style={{ position: 'absolute', right: -8, top: 4, opacity: 0.05, pointerEvents: 'none' }}>
                <Clock size={72} color="#F59E0B" strokeWidth={1} />
              </div>
              <div>
          ...
          <div className="form-image-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', borderRadius: 32, overflow: 'hidden', boxShadow: '0 32px 80px rgba(59,79,204,0.12)', border: '1.5px solid #e8eaf0' }}>
              ...
              {!sent ? (
                <>
                  <div style={{ marginBottom: 36 }}>
                    ...
                    <p style={{ fontSize: '0.95rem', color: '#6B7280', marginTop: 8, lineHeight: 1.65 }}>
                      ...
                      <div>
                        ...
                        <div style={{ position: 'relative' }}>
                          ...
                          <input type="tel" placeholder="(555) 000-0000" value={form.phone}
                            ...
                            style={{ ...inp('phone'), paddingLeft: '40px' }} />
                        </div>
                      </div>
                      <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: 480, textAlign: 'center' }}>
                  ...
                  <h3 style={{ fontSize: '1.8rem', fontWeight: 800, color: '#0d1340', marginBottom: 12 }}>
                    Message Received!
                  </h3>
                  ...
                  <button onClick={() => { setSent(false); setForm({ name: '', email: '', phone: '', service: '', message: '' }); }}
                    style={{ background: '#f0f2ff', color: '#3B4FCC', border: 'none', borderRadius: 12, padding: '12px 28px', fontWeight: 700, fontSize: '0.95rem', cursor: 'pointer', fontFamily: 'Poppins, sans-serif' }}>
            ...
            <div className="image-panel" style={{ position: 'relative', background: 'linear-gradient(150deg, #0d1340 0%, #1e2a80 100%)', overflow: 'hidden', minHeight: 600 }}>
              ...
              <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '52px 44px', zIndex: 2 }}>
                ...
                {/* Central visual — lucide icon as hero graphic */}
                <div style={{ textAlign: 'center' }}>
                  ...
                  <h3 style={{ fontSize: '1.7rem', fontWeight: 800, color: 'white', lineHeight: 1.2, marginBottom: 16 }}>
          ...
          <div style={{ background: 'white', borderRadius: 28, padding: '48px 52px', border: '1.5px solid #eaecf5', display: 'flex', flexWrap: 'wrap', gap: 40, alignItems: 'center', justifyContent: 'space-between', boxShadow: '0 8px 32px rgba(0,0,0,0.04)' }}>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              {serviceAreas.map(({ icon: Icon, label }) => (
                <span key={label} className="area-chip">
            ...
            <a href="/book" style={{ flexShrink: 0, display: 'inline-flex', alignItems: 'center', gap: 8, background: '#0d1340', color: 'white', fontWeight: 700, borderRadius: 14, padding: '14px 28px', fontSize: '0.95rem', textDecoration: 'none', transition: 'background 0.2s' }}
